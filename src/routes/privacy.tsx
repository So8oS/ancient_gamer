    ...
    <div className="flex justify-center px-4 py-12">
      ...
      >
        <div className="flex flex-col items-center gap-6 mb-4">
          ...
          <p style={{ ...pStyle, color: 'rgba(255,255,255,0.4)' }}>Last updated: August 16, 2023</p>
        </div>
        ...
        <p style={pStyle}>
          ...
          <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank" rel="noreferrer" style={linkStyle}>
            Privacy Policy Generator
          </a>
          .
        </p>

        <h1 style={h1Style}>Interpretation and Definitions</h1>
        <h2 style={h2Style}>Interpretation</h2>
        <p style={pStyle}>
        ...
        <ul className="flex flex-col gap-4" style={{ paddingLeft: '16px' }}>
          {[
            [<><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</>],
            [<><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where &quot;control&quot; means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</>],
            [<><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Ancient Gamer.</>],
            ...
            [<><strong>Website</strong> refers to Ancient Gamer, accessible from{' '}<a href="https://www.ancientgamer.net/" rel="external nofollow noopener" target="_blank" style={linkStyle}>https://www.ancientgamer.net/</a></>],
            [<><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</>],
          ].map((item, i) => (
            <li key={i} style={{ listStyleType: 'disc', listStylePosition: 'outside', ...pStyle }}>
              {item}
            </li>
          ))}
        </ul>

        <h1 style={h1Style}>Collecting and Using Your Personal Data</h1>
        <h2 style={h2Style}>Types of Data Collected</h2>
        ...
        <ul style={{ paddingLeft: '16px' }}>
          <li style={{ listStyleType: 'disc', listStylePosition: 'outside', ...pStyle }}>Usage Data</li>
        </ul>
        ...
        <ul className="flex flex-col gap-4" style={{ paddingLeft: '16px' }}>
          <li style={{ listStyleType: 'disc', listStylePosition: 'outside', ...pStyle }}>
        ...
        <p style={pStyle}>
          ...
          <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" target="_blank" rel="noreferrer" style={linkStyle}>
            TermsFeed website
          </a>{' '}
          article.
        </p>
        ...
        <ul className="flex flex-col gap-4" style={{ paddingLeft: '16px' }}>
          ...
          <li style={{ listStyleType: 'disc', listStylePosition: 'outside', ...pStyle }}>
            ...
            Administered by: Us. Purpose: These Cookies identify if users have accepted the use of
            cookies on the Website.
          </li>
          <li style={{ listStyleType: 'disc', listStylePosition: 'outside', ...pStyle }}>
            <strong>Functionality Cookies</strong> — Type: Persistent Cookies. Administered by: Us.
        ...
        <ul className="flex flex-col gap-4" style={{ paddingLeft: '16px' }}>
          {[
            ...
            <li key={i} style={{ listStyleType: 'disc', listStylePosition: 'outside', ...pStyle }}>{item}</li>
          ))}
        </ul>
        ...
        <h2 style={h2Style}>Retention of Your Personal Data</h2>
        <p style={pStyle}>
        ...
        <h2 style={h2Style}>Transfer of Your Personal Data</h2>
        <p style={pStyle}>
        ...
        <h2 style={h2Style}>Delete Your Personal Data</h2>
        <p style={pStyle}>
        ...
        <h3 style={h3Style}>Other legal requirements</h3>
        <p style={pStyle}>
          The Company may disclose Your Personal Data in the good faith belief that such action is
          necessary to:
        </p>
        <ul className="flex flex-col gap-2" style={{ paddingLeft: '16px' }}>
          {[
        ...
        <h1 style={h1Style}>Children's Privacy</h1>
        <p style={pStyle}>
        ...
        <h1 style={h1Style}>Links to Other Websites</h1>
        <p style={pStyle}>
        ...
        <h1 style={h1Style}>Changes to this Privacy Policy</h1>
        <p style={pStyle}>
        ...
        <ul style={{ paddingLeft: '16px' }}>
          <li style={{ listStyleType: 'disc', listStylePosition: 'outside', ...pStyle }}>
            ...
            <a href="https://www.ancientgamer.net/contact" rel="external nofollow noopener" target="_blank" style={linkStyle}>
