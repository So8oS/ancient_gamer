      ...
      <div className="flex flex-col gap-3 bg-orange-800 p-2 md:p-10 rounded-2xl">
        ...
        <ul className="flex flex-col gap-3">
          ...
          <li>
            <p>
              ...
              &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Ancient Gamer.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              <a
                href="https://www.ancientgamer.net/"
        ...
        <ul>
          <li>
            ...
            <a
              href="https://www.ancientgamer.net/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.ancientgamer.net/contact
            </a>
          </li>
        </ul>
      </div>
