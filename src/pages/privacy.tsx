    ...
    <div className="p-4">
      <div className="flex flex-col gap-3 bg-orange-800 p-10 rounded-2xl">
        ...
        <ul className="flex flex-col gap-3">
          ...
          <li>
            <p>
              <strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where &quot;control&quot; means ownership of 50% or more of the
        ...
        <ul>
          <li>
            ...
            However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may
            use Cookies.
          </li>
          <li>
